...
Example for making a bunch of R and Python analyses available in the same MyBinder instance.


## ~~Analysis 1: RStudio openning a specific script~~
[![Analysis 1: RStudio Binder](https://img.shields.io/badge/1-Rstudio-808080.svg?style=for-the-badge)](https://mybinder.org/v2/gh/informatics-lab/binder_rstudio_jupyterlab_example/main?urlpath=rstudio)<br>
...
## Analysis 3: RMarkdown notebook interactively rendered in a Shiny app
...
[![Analysis 4: JupyterLab Binder](https://img.shields.io/badge/4-JupyterLab-F5A252.svg?style=for-the-badge)](https://mybinder.org/v2/gh/informatics-lab/binder_rstudio_jupyterlab_example/main?labpath=analysis-4.ipynb)